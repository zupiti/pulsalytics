              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        'Plugin Inicializado: ${HeatmapTrackerPlugin.isInitialized ? 'Sim' : 'Não'}'),
                    Text(
                        'Server URL: ${HeatmapTrackerPlugin.serverUrl ?? 'N/A'}'),
                    Text(
                        'Qualidade da Imagem: ${HeatmapTrackerPlugin.imageQuality ?? 'N/A'}'),
                    Text(
                        'User ID: ${HeatmapTrackerPlugin.userId ?? 'Não definido'}'),
                  ],
                ),
              ),
            ),
