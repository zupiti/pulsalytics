...
// Variáveis para controle de requisições
let pendingCapture = false;
let lastCaptureTime = 0;
let captureQueue = [];
let minCaptureInterval = 5000; // Mínimo 5 segundos entre capturas
...
function startFastCapture() {
    // Captura controlada com debounce - máximo 1 captura a cada 5 segundos
    ...
    }, 1000); // Verifica a cada 1 segundo, mas só captura se passou o tempo mínimo
}

// Função de captura com debounce
...
function debouncedCapture() {
    ...
    }, 1000); // Aguarda 1 segundo após a última movimentação significativa
}
